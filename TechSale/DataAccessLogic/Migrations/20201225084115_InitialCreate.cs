        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionLots_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BidTimePrice = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AuctionLotId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notes_AuctionLots_AuctionLotId",
                        column: x => x.AuctionLotId,
                        principalTable: "AuctionLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AuctionLotSavedList",
                columns: table => new
                {
                    AuctionLotsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SavedListsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionLotSavedList", x => new { x.AuctionLotsId, x.SavedListsId });
                    table.ForeignKey(
                        name: "FK_AuctionLotSavedList_AuctionLots_AuctionLotsId",
                        column: x => x.AuctionLotsId,
                        principalTable: "AuctionLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuctionLotSavedList_SavedLists_SavedListsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionLots_UserId",
                table: "AuctionLots",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AuctionLotSavedList_SavedListsId",
                table: "AuctionLotSavedList",
                column: "SavedListsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_AuctionLotId",
                table: "Notes",
                column: "AuctionLotId",
                unique: true,
                filter: "[AuctionLotId] IS NOT NULL");
